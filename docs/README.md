...
| `interfirectl` | One-shot CLI: `ping`, `status`, `rules list` / `add` / `delete` |
...
Still building toward: eBPF observation, NFQUEUE verdicts, ratatui TUI, GPUI
tray UI, and Debian packaging.
...
crates/interfire-tui/            reserved ratatui control-plane client
